...
5. **阶段**：判断产品、业务、项目或团队处于探索、验证、PMF、增长、规模化、成熟优化、危机止血或组织对齐阶段。
6. **关键约束**：识别用户价值、供给、流量、信任、转化、数据质量、研发资源、预算、时间、权限、激励、协作中的主要约束。
7. **相关方**：判断结果负责人、执行负责人、否决人、成本承担者、受益人，以及可以争取的中间人群。
8. **证据充分性**：事实够就直接行动；不够就设计最小验证、最小诊断或可回滚试点。
9. **行动模式**：选择一个主模式：立即决策、快速验证、先诊断、优先级排序、谈判对齐、停止投入、升级决策。
10. **停止清单**：明确哪些事现在不要做，避免资源分散、阶段错配或制造噪音。
